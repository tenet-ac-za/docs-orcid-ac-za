---
url: "/hub/manual/writing_affiliation_items"
...
| Organisation | Name of the organisation writing the information (will be filled in automatically, based on the organisationâ€™s onboarding information) |
...
| Affiliation type (required) | employment, education, distinction, invitedposition, qualification, membership, service. NOTE â€“ invited-position must contain a hyphen, otherwise you will encounter a Hub error |
| Role | If writing â€˜Employmentâ€™ â€“ the title of the role (e.g. Associate Professor) If writing â€˜Educationâ€™ â€“ degree title, level and result of the degree awarded, e.g. Batchelor of Science If writing â€˜Qualificationâ€™ â€“ title or result of the course or professional certification If writing â€˜Invited-positionâ€™ â€“ the name of the position, e.g. â€˜honorary vising scholarâ€™ If writing â€˜Distinctionâ€™ â€“ the prize or award name, e.g. â€˜Hutton medalâ€™ If writing â€˜Membershipâ€™ â€“ the nature of themembership, e.g. professional member, studentmember If writing â€˜Serviceâ€™ â€“ the nature of the service,e.g. panel member, panel chair |
...
To upload â€˜affiliationsâ€™ file to the Hub log-in and go to
>Tasks >Upload affiliations ...upload your fileâ€¦>activate all
This will either
